...
public final class XCTestDirectories
{
  private static final Logger LOGGER =
    LoggerFactory.getLogger(XCTestDirectories.class);

  private XCTestDirectories()
  {
    ...
    throws IOException
  {
    ...
    final var path = Path.of(property).resolve("xoanon");
  ...
  public static Path resourceOf(
    ...
    throws IOException
  {
    final var internal = String.format("/com/io7m/xoanon/tests/%s", name);
